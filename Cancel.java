...
public class Cancel extends JFrame implements ActionListener {
   ...
   public Cancel() {
      ...
      heading.setBounds(280, 20, 290, 35);
      ...
      this.fetchButton.setBackground(new Color(70,130,180));
      this.fetchButton.setForeground(Color.WHITE);
      this.fetchButton.setBounds(380, 80, 120, 25);
      ...
      // Corrected cancellation number generation
      this.cancellationno = new JLabel(String.valueOf(random.nextInt(1000000))); // Fixed
      ...
      this.flight.setBackground(new Color(70,130,180));
